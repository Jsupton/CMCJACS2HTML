...
public class UseCaseTests {
	...
	public void testLogOnFailsForInvalidUsername() {
		int actual = ac.logOn("JJJJ", "user");
		int expected = 1;
		assertEquals("the Login Number is "+expected, expected, actual);}
	...
	public void testLogOnFailsForInvalidPassword() {
		int actual = ac.logOn("juser", "JJJJJ");
		int expected = 2;
		assertEquals("the Login Number is "+expected, expected, actual);}
	...
	public void testLogOnFailsForDeactivatedAccount() {
		int actual = ac.logOn("luser", "luser");
		int expected = 4;
		assertEquals("the Login Number is "+expected, expected, actual);}
	...
	public void UseCase5ManageUniversities() {
		...
		ac.logOn("nadmin", "admin");
		Account acc = ac.displayAccount();
		if (acc != null) {
